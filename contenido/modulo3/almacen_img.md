...
Vamos a crear la estructura de directorios y vamos a crear los ficheros dentro de cada capa:
...
Siendo el directorio `work` un directorio temporal necesario para el funcionamiento del sistema.
